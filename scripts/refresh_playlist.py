...
def main() -> int:
    ...
    # bump the script url so returning viewers don't keep a cached playlist
    index = ROOT / "index.html"
    index.write_text(re.sub(r'videos\.js\?v=[\d-]+', f"videos.js?v={payload['generated']}", index.read_text()))
